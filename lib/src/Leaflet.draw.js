...
L.drawLocal = {
	...
	draw: {
		...
		handlers: {
			...
			polyline: {
				error: '<strong>Erreur:</strong> Les bords de forme ne peuvent pas traverser!',
				tooltip: {
					start: 'Cliquez pour commencer la ligne de dessin.',
					cont: 'Cliquez pour continuer la ligne de dessin.',
			...
			simpleshape: {
				tooltip: {
					end: 'Déverrouiller la souris pour terminer le dessin.'
				}
			}
		}
	},
	edit: {
		toolbar: {
			actions: {
				...
				cancel: {
					title: 'Annuler l édition, rejette tous les changements.',
					text: 'Annuler'
				},
				clearAll:{
		...
		handlers: {
			edit: {
				tooltip: {
					text: 'Traits de glissement ou marqueur pour modifier la fonction.',
					subtext: 'Cliquez sur Annuler pour annuler les modifications.'
				}
			},
			remove: {
				tooltip: {
					text: 'Cliquez sur une fonctionnalité pour supprimer'
				}
			}
		}
	}
